...
def output_header():
    ...
    print( '<!-- generated by fan-chart', get_version, '-->' )
...
if len(id_match) == 1:
   ...
   if max_generations > 1:
      ...
      print( '<rect x="50" y="5" width="40" height="40" fill="red" />' )
      print( '<rect x="50" y="5" width="40" height="40" fill="blue" transform="rotate(45)" /> ')
