...
# page width will be big circle diameter plus more
page_width = 2 * outer + outer / 5

# height will contain two circles plus a bit more
page_height = 4 * outer + outer / 3
...
print( '' )
print( '<!-- draw x axis -->' )
print( '<path d="M' + center + ' ' + roundstr(cx+page_width/2) + ',' + roundstr(cy) + '" style="stroke:blue;" />' )
print( '' )
...
print( '' )
print( '<!-- transform to second center -->' )
print( '<g transform="translate(' + center + ')">' )
...
print( '<!-- same path, using an id for the text output -->' )
print( '<path id="text1" d="M' + t1 + ' ' + t2 + '" style="fill:none;" />' )
print( '<text font-size="9.5" font-family="Times New Roman,serif">' )
print( ' <textPath xlink:href="#text1">First Last Name</textPath>' )
print( '</text>' )
